            ...
            <div className="w-full max-w-screen-md mx-auto min-h-[380px] bg-white shadow rounded-lg grid sm:grid-cols-2 gap-4 my-10">
                <div className="w-full h-full relative">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 p-4">
                        <h3 className="h3 text-center flex flex-col items-center">Welcome back to <span className="text-green-900">Work Hub!</span></h3>
                        <div className="w-full bg-white/50 backdrop-blur-3xl rounded-lg">
                            <p className="text-xs p-4 text-center">Don't have any account? <Link href={"/register"} className="text-green-900">
                                Register Now
                            </Link> </p>
                        </div>
                    </div>
                ...
                <div className="p-4 flex flex-col gap-6">
                    <h3 className="h3 text-center text-green-900">Login Now</h3>
